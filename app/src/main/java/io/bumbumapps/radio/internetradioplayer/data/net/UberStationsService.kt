package io.bumbumapps.radio.internetradioplayer.data.net

import io.bumbumapps.radio.internetradioplayer.data.net.ubermodel.StationIdSearch
import io.bumbumapps.radio.internetradioplayer.data.net.ubermodel.StationsSearch
import io.bumbumapps.radio.internetradioplayer.data.net.ubermodel.SuggestionsSearch
import io.bumbumapps.radio.internetradioplayer.data.net.ubermodel.TopSongsSearch
